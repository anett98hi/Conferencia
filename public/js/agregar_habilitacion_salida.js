function agregar_habilitacion_salida() {
    ...
    var tabla = document.getElementById("TablaHabilitacion");
        ...
        campo6.type = "number";
        campo6.name = "cantidad_inventario[][cantidad_inventario]";
        campo6.value = document.getElementById("cantidad_inventario").value;
        ...
        if(campo7.value <=  "0"){
            return alert("El campo CANTIDAD DE SALIDA no puede ser 0 o menor");
         }
         if(Number(campo7.value) > Number(campo6.value)){
            return alert("El campo CANTIDAD DE SALIDA debe ser menor o igual al campo CANTIDAD EN INVENTARIO");
         }
