...
function agregar_tela() {
 ...
 var tabla = document.getElementById("tablaTelasDevoluciones");
 
 

 
 var tipoTela = document.getElementById("telaTipoDevolucion");
 ...
 var campo1 = document.createElement("input");
     ...
     var clave_tela_id = document.getElementById("cveTelaDevolucion");
...
var campo_clave_tela = document.createElement("input");
 ...
 var claveTela = document.getElementById("cveTelaDevolucion").value;
 var campo2 = document.createElement("input");
     campo2.type = "text";
     campo2.name = "clave_tela[][clave_tela]";
     campo2.value = claveTela;
     campo2.readOnly = "true";
     if(campo_clave_tela.value === "Seleccione Clave de de Tela"){
        return alert("Debes seleccionar una CLAVE DE TELA");
    }
 
 var descripcionTela = document.getElementById("telaDesDevolucion").value;
 ...
 var campo4 = document.createElement("input");
     ...
     campo4.value = document.getElementById("telaUniDevolucion").value;
     campo4.readOnly = "true";
 
 var inputColor = document.getElementById("colorTelaDevolucion");
 ...
 var campo6 = document.createElement("input");
     ...
     campo6.value = document.getElementById("cantidadDisponibleDevolucion").value;
     campo6.readOnly = "true";

 var campo7 = document.createElement("input");
     campo7.type = "text";
     campo7.name = "cantidadReingreso[][cantidadReingreso]";
     campo7.value = document.getElementById("cantidadDevolucion").value;
     campo7.readOnly = "true";

     if (campo7.value.trim() == "") {
        campo7.focus();
        return alert("El campo CANTIDAD DE DEVOLUCIÓN esta vació");
    }
    if(campo7.value <=  "0"){
        return alert("El campo CANTIDAD DE LA DEVOLUCIÓN no puede ser 0 o menor");
     }
    if(Number(campo7.value) > Number(campo6.value)){
        return alert("El campo CANTIDAD DE LA DEVOLUCIÓN debe ser menor o igual al campo CANTIDAD DE ENTRADA");
     }
